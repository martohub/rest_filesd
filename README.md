# REST API which stores targets and labels in sqlite3 database and converts them to YAML files, so they can be scraped by Prometheus 
...
pip install -r requirements.txt      #and ignore all frontend errors for now
